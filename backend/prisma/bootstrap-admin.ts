...
const permissions = [
  "dashboard.view", "staff.view", "staff.create", "staff.update", "staff.delete", "staff.restore",
  ...
  "applications.view", "applications.update", "applications.assign", "applications.export",
  "media.view", "media.upload", "media.delete", "website.view", "website.update", "website.publish",
  "admins.view", "admins.create", "admins.update", "admins.disable", "admins.reset_password", "admins.change_role",
