...
export async function ResearchProjectsPage() {
  ...
  return <main className={styles.page} id="main-content">
    ...
    <section className={styles.projectHero} aria-labelledby="project-page-title">
      <Image src="/images/pages/research/content/campus.jpg" alt="Hoạt động dự án nghiên cứu tại Viện Sau Đại học" fill priority sizes="100vw" />
    ...
    <PublicationsSearch publications={projects} titleSecond="Dự án nghiên cứu Viện Sau Đại học" breadcrumbLast="Dự án nghiên cứu" searchPlaceholder="Tìm kiếm Dự án nghiên cứu" resultLabel="dự án"/>
