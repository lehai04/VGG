...
/**
 * Nội dung "Vì sao chọn VGG" được đặt cứng ở đây vì có cấu trúc giàu hơn
...
const reasons = [
  {
    ...
    img: "/images/programmers/pic_pro.jpg",
  ...
  },
  {
    ...
    img: "/images/hero/campus-hero.jpg",
    keywords: null,
  },
  {
    bg: "navy" as const,
...
/** Trang "Vì sao chọn VGG" (/discover/vi-sao-chon-vgg) theo phong cách VisionMissionPage. */
export function WhyVGGPage() {
  return (
    <main className={`${styles.page} subpage`} id="main-content">
      <RevealOnScroll />
      <SiteHeader compact />
