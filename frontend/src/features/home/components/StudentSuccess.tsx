...
const STUDENT_SERVICES = [
  ...
  { title:"Cộng đồng người học", description:"Môi trường kết nối, chia sẻ và học hỏi giữa người học, giảng viên và cộng đồng.", href:"/student-success/cuu-hoc-vien", linkLabel:"Tìm hiểu thêm" },
...
/** HOMEPAGE SECTION: Dịch vụ hỗ trợ và hành trình thành công của người học. */
  ...
  return (
    ...
    <section className="studentSuccess" id="student-success">
      ...
      <div className="studentSuccessIntro">
        <p>STUDENT SUCCESS · HÀNH TRÌNH NGƯỜI HỌC</p>
        <h2>
          Đồng hành để
          <br />
        ...
        <div>
          ...
          đồng hành xuyên suốt hành trình của người học.
        </div>
        <a href="#student-success">Khám phá dịch vụ người học ↗</a>
      </div>

      <EditorialAccordion items={STUDENT_SERVICES} label="Dịch vụ hỗ trợ người học" className="studentServices" />
    </section>
  );
}
