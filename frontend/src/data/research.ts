...
export const researchSubpages: readonly ResearchSubpageData[] = [
  {
    ...
    intro:
      "Viện Sau Đại học tổ chức nghiên cứu theo mô hình cụm liên ngành — nơi các học giả từ kinh tế, kỹ thuật, khoa học xã hội và nghệ thuật cùng đặt câu hỏi và cùng kiếm tìm lời giải. Cách tiếp cận này tạo ra những phát hiện mà một ngành riêng lẻ không thể đạt được.",
    image:
    ...
    quoteAttrib: "Viện Sau Đại học Research Direction",
  },
  {
    slug: "du-an",
    ...
    intro:
      "Mỗi dự án nghiên cứu tại Viện Sau Đại học bắt đầu từ một vấn đề thực tế — không phải từ lý thuyết trừu tượng. Người học, giảng viên và đối tác doanh nghiệp cùng định nghĩa câu hỏi, thiết kế phương pháp và đánh giá kết quả theo tiêu chuẩn quốc tế.",
    image:
    ...
    highlights: [
      ...
      },
      {
        ...
        body: "Từ báo cáo chính sách đến prototype sản phẩm, Viện Sau Đại học kết nối kết quả nghiên cứu với những người có thể đưa chúng vào thực tiễn.",
      },
    ],
    quote:
    ...
    quoteAttrib: "Viện Sau Đại học Research Ethics",
  },
  {
    slug: "cong-bo",
    ...
    intro:
      "Công bố khoa học là thước đo và di sản của nghiên cứu. Viện Sau Đại học khuyến khích công bố trên các tạp chí uy tín quốc tế, đồng thời ưu tiên truy cập mở — để tri thức không bị giới hạn bởi tường lửa chi phí.",
    image:
    ...
    highlights: [
      {
        ...
        body: "Các nhà nghiên cứu Viện Sau Đại học công bố trên tạp chí Scopus, ISI và các hội nghị khoa học hàng đầu trong ngành — đưa tên Văn Lang vào bản đồ học thuật toàn cầu.",
      },
      {
        index: "02",
        title: "Cơ sở dữ liệu mở",
        body: "Viện Sau Đại học duy trì repository học thuật mở, nơi các công trình nghiên cứu được lưu trữ và chia sẻ tự do — thúc đẩy văn hóa open science trong cộng đồng.",
      },
      {
        index: "03",
    ...
    quoteAttrib: "Viện Sau Đại học Open Knowledge Initiative",
  },
  {
    slug: "hoi-thao",
    ...
    intro:
      "Hội thảo khoa học là nơi ý tưởng được thử thách và làm sắc nét. Viện Sau Đại học tổ chức và tham gia các sự kiện học thuật quốc tế — từ seminar nhỏ đến hội nghị lớn — để kết nối cộng đồng nghiên cứu vượt qua biên giới địa lý và ngành học.",
    image:
    ...
    highlights: [
      ...
      },
      {
        ...
        body: "Chuỗi seminar hàng tháng với diễn giả trong và ngoài nước, tập trung vào các phát hiện nghiên cứu mới nhất — mở cửa cho toàn cộng đồng Viện Sau Đại học.",
      },
      {
        index: "03",
    ...
    quoteAttrib: "Viện Sau Đại học Academic Community",
  },
  {
    ...
    intro:
      "Đổi mới không phải là sản phẩm của may mắn — đó là kết quả của tư duy có phương pháp, môi trường an toàn để thử nghiệm và văn hóa sẵn sàng học từ thất bại. Viện Sau Đại học xây dựng hệ sinh thái đổi mới kết nối học thuật, công nghệ và nhu cầu thực tiễn.",
    image:
    ...
    quoteAttrib: "Viện Sau Đại học Innovation Philosophy",
  },
  {
    ...
    intro:
      "Ranh giới giữa đại học và doanh nghiệp ngày càng mờ dần — và đó là điều tốt. Viện Sau Đại học xây dựng quan hệ đối tác chiến lược với các doanh nghiệp dẫn đầu ngành để nghiên cứu đáp ứng nhu cầu thực tế và người học được chuẩn bị tốt nhất cho thị trường lao động.",
    image:
    ...
    highlights: [
      {
        ...
        body: "Doanh nghiệp đặt hàng nghiên cứu — Viện Sau Đại học cung cấp năng lực học thuật và độc lập khoa học. Mô hình này đảm bảo kết quả vừa ứng dụng được vừa có chất lượng học thuật.",
      },
      {
        index: "02",
        title: "Industry Advisory Boards",
        body: "Lãnh đạo doanh nghiệp tham gia hội đồng tư vấn chương trình đào tạo và nghiên cứu — đảm bảo Viện Sau Đại học luôn đi đúng hướng với nhu cầu thực tế của nền kinh tế.",
      },
      {
        index: "03",
    ...
    quoteAttrib: "Viện Sau Đại học Partnership Vision",
  },
];
