...
| `CLOUDINARY_CLOUD_NAME` | **Bắt Buộc cho CMS** | Tên Cloudinary Cloud lưu ảnh bài viết & PDF | `<YOUR_CLOUDINARY_CLOUD_NAME>` |
| `CLOUDINARY_API_KEY` | **Bắt Buộc cho CMS** | API Key Cloudinary | `<YOUR_CLOUDINARY_API_KEY>` |
| `CLOUDINARY_API_SECRET` | **Bắt Buộc cho CMS** | Secret Key Cloudinary | `<YOUR_CLOUDINARY_API_SECRET>` |
| `CLOUDINARY_MAX_RESOURCE_FILE_MB` | Không | Giới hạn dung lượng tệp CMS (MB, mặc định 10) | `25` |
